(function(global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ? factory(exports, require('tinygradient'))
    : typeof define === 'function' && define.amd
    ? define(['exports', 'tinygradient'], factory)
    : ((global = global || self),
      factory((global['gradient-path'] = {}), global.tinygradient));
})(this, function(exports, tinygradient) {
  'use strict';

  tinygradient =
    tinygradient && tinygradient.hasOwnProperty('default')
      ? tinygradient['default']
      : tinygradient;
  ...
  var styleAttrs = function styleAttrs(fill, stroke, strokeWidth, progress) {
    var determineColor = function determineColor(type, progress) {
      return typeof type === 'string'
        ? type
        : tinygradient(type).rgbAt(progress);
    };
  ...
  var outlineStrokes = function outlineStrokes(data, width, precision) {
    ...
    for (var i = 0; i < data.length; i++) {
      ...
      for (var j = 0; j < samples.length; j++) {
        ...
        if (j === 0) {
          segmentSamples.push.apply(
            segmentSamples,
            _toConsumableArray(p0Perps)
          );
